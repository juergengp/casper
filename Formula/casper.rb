class Casper < Formula
  ...
  homepage "https://github.com/juergengp/casper"
  version "2.3.1"
  license "MIT"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/juergengp/casper/raw/main/bin/casper-arm64"
      sha256 "32253b5817eae538815bde58a0b0593921ca43684cfc91619d25b4cf7b462c56"
    else
      url "https://github.com/juergengp/casper/raw/main/bin/casper-x86_64"
